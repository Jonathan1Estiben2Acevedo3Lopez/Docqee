...
import type { AdminShellContent, AdminShellNavigationIcon } from '@/content/types';
...
function isNavigationItemActive(targetPath: string, pathname: string, matchPrefix?: string) {
        ...
        <div className="flex min-h-0 flex-1 flex-col gap-4 overflow-hidden rounded-[2.25rem] bg-[#f4f8ff] p-1 sm:p-1.5">
          ...
          <div className="flex min-h-0 flex-1 flex-col gap-6 lg:flex-row lg:items-stretch">
              ...
              >
                ...
                >
                  <span
                    className={classNames(
                      ...
                      isSidebarCollapsed ? 'max-w-0 opacity-0' : 'max-w-[9rem] opacity-100',
                    )}
                  >
                    MENÚ
                  </span>
                  <button
                    ...
                    className={classNames(
                      ...
                      isSidebarCollapsed ? 'absolute left-1/2 -translate-x-1/2' : 'absolute right-0',
                    )}
                ...
                <nav
                  ...
                  className={classNames(
                    ...
                    isSidebarCollapsed ? 'mt-0 hidden lg:mt-5 lg:block' : 'mt-5',
                  )}
                      ...
                      >
                        ...
                        <span
                          className={classNames(
                            ...
                            isSidebarCollapsed ? 'lg:max-w-0 lg:opacity-0' : 'lg:max-w-[12rem] lg:opacity-100',
                          )}
                        >
                          {item.label}
                        </span>
                ...
                <div
                  className={classNames(
                    ...
                    isSidebarCollapsed ? 'hidden pt-0 lg:block lg:pt-6' : 'block pt-6',
                  )}
                >
                  <Link
                    className={classNames(
            ...
            <div className="min-h-0 min-w-0 flex-1 transition-[width] duration-300">
              <main
                className="h-full overflow-y-auto pt-1 lg:pt-0"
